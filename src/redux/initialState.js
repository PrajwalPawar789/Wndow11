...
const initialState = {
    ...
    },
    {
      ...
      onClick: () => {
        const textMessage = encodeURIComponent(
          "Hello Pooja Kothawale!, [your message here]"
        );
        window.open(
  ...
  shortcutApps: [
    ...
    },
    {
      ...
      onClick: () => {
        window.open(
          "https://www.linkedin.com/in/pooja-kothawale",
          "_blank",
          WIN_FEATURES
        );
      },
    ...
    },
    {
      ...
      width: 35,
      height: 35,
      onClick: () => (window.location.href = "mailto:poojakothawale1105@gmail.com"),
    },
    // {
    //   name: "Search",
    ...
    },
    {
      ...
      onClick: () => {
        window.open(
          "https://shopping-page-one.vercel.app/",
          "_blank",
          WIN_FEATURES
        );
      },
